...
#define hxconsole_command(x_) static hxdetail_::hxconsole_constructor_ \
	hxg_console_symbol_##x_(hxdetail_::hxconsole_command_factory_(&(x_)), #x_)
...
#define hxconsole_command_named(x_, name_) static hxdetail_::hxconsole_constructor_ \
	hxg_console_symbol_##name_(hxdetail_::hxconsole_command_factory_(&(x_)), #name_)
...
/// ```
#define hxconsole_variable(x_) static hxdetail_::hxconsole_constructor_ \
	hxg_console_symbol_##x_(hxdetail_::hxconsole_variable_factory_(&(x_)), #x_)
...
/// ```
#define hxconsole_variable_named(x_, name_) static hxdetail_::hxconsole_constructor_ \
	hxg_console_symbol_##name_(hxdetail_::hxconsole_variable_factory_(&(x_)), #name_)
