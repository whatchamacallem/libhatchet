...
template<typename T_, typename deleter_t_>
template<typename deleter_u_>
hxinline hxattr_flatten void hxlist<T_, deleter_t_>::erase(const_iterator pos_, deleter_u_&& deleter_) noexcept {
...
template<typename T_, typename deleter_t_>
hxinline hxattr_flatten void hxlist<T_, deleter_t_>::erase(const_iterator pos_) noexcept {
	this->erase(pos_, static_cast<deleter_t_&>(*this));
}

template<typename T_, typename deleter_t_>
hxinline hxattr_flatten hxptr<T_, deleter_t_> hxlist<T_, deleter_t_>::extract(const_iterator pos_) {
...
template<typename T_, typename deleter_t_>
hxinline hxattr_flatten auto hxlist<T_, deleter_t_>::insert_after(const_iterator pos_, T_* ptr_) -> iterator {
...
template<typename T_, typename deleter_t_>
hxinline hxattr_flatten void hxlist<T_, deleter_t_>::insert_(
...
template<typename T_, typename deleter_t_>
hxinline hxattr_flatten void hxlist<T_, deleter_t_>::extract_(hxlist_node* prev_, hxlist_node* ptr_) {
	hxassert_hard(!this->empty(), "empty_list");
	hxassertmsg(ptr_ != hxnull, "invalid_node");
	hxlist_node* next_ = reinterpret_cast<hxlist_node*>(
