...
template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
hxinline node_t_&
hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::iterator::operator*(void) const {
...
template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
hxinline hxattr_flatten hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::const_iterator::const_iterator(const hxhash_table* table_)
...
template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
hxinline hxattr_flatten hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::const_iterator::const_iterator(
...
template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
hxinline hxattr_flatten auto hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::const_iterator::operator++(void)
		-> const_iterator& {
...
template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
hxinline void hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::const_iterator::next_bucket_(void) {
...
template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
hxinline hxattr_flatten hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::hxhash_table(deleter_t_ deleter_)
...
hxinline hxattr_flatten void hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::add_range(
...
hxinline hxattr_flatten auto hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::and_then(
...
hxinline hxattr_flatten void hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::clear(
...
hxinline hxattr_flatten hxsize_t hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::count(
	...
	hxif_constexpr(!(traits_ & hxtrait_multi)) {
		...
		return this->chain_count_multi_(head_, &key_, &hxhash_equal_trampoline_<node_t_, traits_>);
	}
}
...
template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
template<typename deleter_u_>
hxinline hxattr_flatten hxsize_t hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::erase(
	...
	hxif_constexpr(!(traits_ & hxtrait_multi)) {
		...
		const hxsize_t erased_ = this->chain_erase_multi_(head_, &key_,
			&hxhash_equal_trampoline_<node_t_, traits_>, deleter_fn_, &deleter_);
		m_size_ -= erased_;
		return erased_;
	}
}
...
template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
hxinline hxattr_flatten hxsize_t hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::erase(const typename node_t_::key_t& key_) noexcept {
	return this->erase(key_, static_cast<deleter_t_&>(*this));
}

template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
hxinline hxattr_flatten typename hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::iterator
hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::erase(const const_iterator& it_) noexcept {
...
hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::extract(
...
hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::extract(
	...
	node_t_* const node_ = static_cast<node_t_*>(this->chain_extract_(
		this->get_bucket_head_(hash_), &key_, &hxhash_equal_trampoline_<node_t_, traits_>));
	m_size_ -= node_ != hxnull;
	return hxptr<node_t_, deleter_t_>(node_, static_cast<deleter_t_&>(*this));
}

template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
hxinline hxattr_flatten auto hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::find(
...
template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
hxinline hxattr_flatten bool hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::has_value(
...
hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::deleter(void) const {
	return static_cast<const deleter_t_&>(*this);
}

template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
hxinline hxattr_flatten deleter_t_& hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::deleter(void) {
	return static_cast<deleter_t_&>(*this);
}

template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
hxattr_flatten typename hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::iterator
hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::insert(node_t_* ptr_) noexcept {
...
template<typename deleter_u_>
hxattr_flatten typename hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::iterator
hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::insert(hxptr<node_t_, deleter_u_>&& ptr_) noexcept {
...
template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
hxinline hxattr_flatten float hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::load_factor(void) const {
...
template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
hxattr_flatten hxsize_t hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::load_max(void) const {
	hxsize_t maximum_ = 0;
...
template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
template<typename self_t_, typename callable_t_>
hxinline hxattr_flatten auto hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::or_else(
		this self_t_&& self_, const key_t& key_, callable_t_&& callable_)
		-> decltype(self_.end()) {
...
template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
hxinline hxattr_flatten void hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::release_all(void) {
	if(m_size_ != 0) {
...
template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
hxinline hxattr_flatten hxsize_t hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::release_key(
...
template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
hxattr_flatten hxptr<node_t_, deleter_t_>
hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::replace(node_t_* ptr_) noexcept {
	...
	node_t_* const replaced_ = static_cast<node_t_*>(this->chain_replace_(
		...
		&ptr_->hash_key(), &hxhash_equal_trampoline_<node_t_, traits_>));
	m_size_ += replaced_ == hxnull;
	return hxptr<node_t_, deleter_t_>(replaced_, static_cast<deleter_t_&>(*this));
}

template<hxhash_table_concept_ node_t_, typename deleter_t_, uint32_t table_size_bits_, int traits_>
hxinline hxattr_flatten void hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::set_size_bits(hxhash_t bits_) {
...
hxinline hxattr_flatten auto hxhash_table<node_t_, deleter_t_, table_size_bits_, traits_>::value_or(
