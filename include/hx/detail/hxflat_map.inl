...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline auto hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::const_iterator::operator+=(
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxsize_t hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::const_iterator::operator-(
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline bool hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::const_iterator::operator==(
		const const_iterator& x_) const {
	hxassertf(m_map_ != hxnull && m_map_ == x_.m_map_, "bad_iter");
	return m_index_ == x_.m_index_;
}
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten const key_t_& hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::const_iterator::key(void) const {
	hxassertf(m_map_ != hxnull, "bad_iter");
	hxassertf(static_cast<size_t>(m_index_) < static_cast<size_t>(m_map_->m_size_), // NOLINT(clang-analyzer-core.NullDereference)
		"bad_iter %zd size %zd", m_index_, m_map_->m_size_);
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten const mapped_t_& hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::const_iterator::value(void) const {
	hxassertf(m_map_ != hxnull, "bad_iter");
	hxassertf(static_cast<size_t>(m_index_) < static_cast<size_t>(m_map_->m_size_), // NOLINT(clang-analyzer-core.NullDereference)
		"bad_iter %zd size %zd", m_index_, m_map_->m_size_);
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten mapped_t_& hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::iterator::value(void) const {
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::hxflat_map(void)
	: m_size_(0) {
}

template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::hxflat_map(const hxflat_map& x_) noexcept
	: m_size_(0) {
	this->operator=(x_);
}

template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::hxflat_map(
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::hxflat_map(hxflat_map&& x_) noexcept {
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::~hxflat_map(void) noexcept {
	this->clear();
}
...
hxinline hxattr_flatten auto hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::and_then(
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten void hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::operator=(
...
hxinline hxattr_flatten void hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::operator=(
		const hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_x_, three_way_>& x_) noexcept {
	hxassertf(static_cast<const void*>(this) != static_cast<const void*>(&x_), "bad_ref");
	this->clear();
	const hxsize_t size_ = x_.m_size_;
	const key_t_* hxrestrict ks_ = x_.m_keys_.data();
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten auto hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::operator[](
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten void hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::clear(void) noexcept {
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten hxsize_t hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::count(const key_t_& key_) const {
	const compare_t comp_;
	const key_t_* const keys_ = m_keys_.data();
	const key_t_* const end_ = keys_ + m_size_;
	hxif_constexpr(!multi_t_) {
		return hxlower_bound_search_<hxrange<const key_t_*>, key_t_, compare_t, three_way_>(
			hxmake_range(keys_, end_), key_, comp_).b ? 1 : 0;
	}
	else {
		const key_t_* const it_ = hxlower_bound_search_<hxrange<const key_t_*>, key_t_, compare_t, three_way_>(
			hxmake_range(keys_, end_), key_, comp_).a;
		return hxupper_bound_<hxrange<const key_t_*>, key_t_, compare_t, three_way_>(
...
hxinline hxattr_flatten auto hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::emplace(
		const key_t_& key_, args_t_&&... args_) noexcept -> iterator {
	const compare_t comp_;
	const key_t_* const keys_ = m_keys_.data();
	const key_t_* const end_ = keys_ + m_size_;
	hxif_constexpr(!multi_t_) {
		const auto lo_ = hxlower_bound_search_<hxrange<const key_t_*>, key_t_, compare_t, three_way_>(
		...
		const hxsize_t index_ = hxlower_bound_search_<hxrange<const key_t_*>, key_t_, compare_t, three_way_>(
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
template<hxsize_t capacity_x_>
hxinline hxattr_flatten bool hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::operator==(
		const hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_x_, three_way_>& x_) const {
	return hxequal_range(*this, x_);
}

template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxattr_flatten hxsize_t hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::erase(const key_t_& key_) noexcept {
	const compare_t comp_;
	const hxsize_t size_ = m_size_;
	key_t_* hxrestrict k_ = m_keys_.data();
	key_t_* const end_ = k_ + size_;
	hxif_constexpr(!multi_t_) {
		const auto lo_ = hxlower_bound_search_<hxrange<key_t_*>, key_t_, compare_t, three_way_>(
		...
		const hxsize_t index_ = hxlower_bound_search_<hxrange<key_t_*>, key_t_, compare_t, three_way_>(
			hxmake_range(k_, end_), key_, comp_).a - k_;
		mapped_t_* hxrestrict v_ = m_values_.data();
		const hxsize_t hi_ = hxupper_bound_<hxrange<key_t_*>, key_t_, compare_t, three_way_>(
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxattr_flatten auto hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::erase(const_iterator it_)
		noexcept -> iterator {
	const hxsize_t size_ = m_size_;
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten auto hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::find(
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten bool hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::has_value(
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten auto hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::insert(
...
hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::keys(void) const noexcept {
	return m_keys_.data();
}
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten auto hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::lower_bound(const key_t_& key_) const
		-> const_iterator {
	const compare_t comp_;
	const key_t_* const keys_ = m_keys_.data();
	return const_iterator(this, hxlower_bound_search_<hxrange<const key_t_*>, key_t_, compare_t, three_way_>(
		hxmake_range(keys_, keys_ + m_size_), key_, comp_).a - keys_);
}

template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten auto hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::lower_bound(const key_t_& key_)
		-> iterator {
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
template<typename self_t_, typename callable_t_>
hxinline hxattr_flatten auto hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::or_else(
		this self_t_&& self_, const key_t_& key_, callable_t_&& callable_)
		-> decltype(self_.end()) {
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten void hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::reserve(hxsize_t cap_,
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten void hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::swap(
		hxflat_map& x_) noexcept {
	static_assert(capacity_ == hxallocator_dynamic_capacity,
...
template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten auto hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::upper_bound(const key_t_& key_) const
		-> const_iterator {
	const compare_t comp_;
	const key_t_* const keys_ = m_keys_.data();
	return const_iterator(this, hxupper_bound_<hxrange<const key_t_*>, key_t_, compare_t, three_way_>(
		hxmake_range(keys_, keys_ + m_size_), key_, comp_) - keys_);
}

template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten auto hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::upper_bound(const key_t_& key_)
		-> iterator {
...
hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::values(void) const noexcept {
	return m_values_.data();
}

template<hxflat_map_concept_ key_t_, hxflat_map_concept_ mapped_t_, typename compare_t_, bool multi_t_, hxsize_t capacity_, bool three_way_>
hxinline hxattr_flatten mapped_t_*
hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::values(void) noexcept {
	return m_values_.data();
}
...
hxinline hxattr_flatten mapped_t_
hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::value_or(
...
hxattr_flatten auto hxflat_map<key_t_, mapped_t_, compare_t_, multi_t_, capacity_, three_way_>::insert_at_(
