...
template<typename T_, typename deleter_t_>
hxinline hxconstexpr hxptr<T_, deleter_t_>::hxptr(hxptr&& other_) noexcept
...
template<typename T_, typename deleter_t_>
hxinline hxconstexpr hxptr<T_, deleter_t_>& hxptr<T_, deleter_t_>::operator=(hxptr&& other_) noexcept {
...
template<typename T_, typename deleter_t_>
hxinline hxconstexpr bool hxptr<T_, deleter_t_>::operator==(const hxptr& other_) const {
	return m_ptr_ == other_.m_ptr_;
}

template<typename T_, typename deleter_t_>
hxinline hxconstexpr bool hxptr<T_, deleter_t_>::operator==(hxnullptr_t) const {
...
hxinline hxconstexpr auto hxptr<T_, deleter_t_>::and_then(function_t_&& callable_) const
...
template<typename T_, typename deleter_t_>
template<typename function_t_>
hxinline hxconstexpr hxptr<T_, deleter_t_> hxptr<T_, deleter_t_>::or_else(function_t_&& callable_) && {
	if(m_ptr_ != hxnull) {
		return hxmove(*this);
	}
...
template<typename T_, typename deleter_t_>
hxinline hxconstexpr void hxptr<T_, deleter_t_>::swap(hxptr& other_) noexcept {
