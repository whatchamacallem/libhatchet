...
inline hxconstexpr auto hxconst_list<node_t_, deleter_t_>::const_iterator::operator++(void)
		-> const_iterator& {
...
template<typename node_t_, typename deleter_t_>
inline hxconstexpr auto hxconst_list<node_t_, deleter_t_>::const_iterator::operator++(int)
		-> const_iterator {
...
template<typename node_t_, typename deleter_t_>
inline hxconstexpr bool hxconst_list<node_t_, deleter_t_>::const_iterator::operator==(
...
template<typename node_t_, typename deleter_t_>
inline hxconstexpr auto hxconst_list<node_t_, deleter_t_>::iterator::operator++(int) -> iterator {
	iterator t_(*this);
...
template<typename node_t_, typename deleter_t_>
inline hxconstexpr hxconst_list<node_t_, deleter_t_>::hxconst_list(void) {
	m_size_ = 0u;
...
template<typename node_t_, typename deleter_t_>
inline hxconstexpr node_t_& hxconst_list<node_t_, deleter_t_>::back(void) {
	hxassert_hard(!this->empty(), "empty_list");
	return *static_cast<node_t_*>(m_sentinel_.m_list_prev_);
}

template<typename node_t_, typename deleter_t_>
inline hxconstexpr const node_t_& hxconst_list<node_t_, deleter_t_>::back(void) const {
	hxassert_hard(!this->empty(), "empty_list");
	return *static_cast<const node_t_*>(m_sentinel_.m_list_prev_);
}

template<typename node_t_, typename deleter_t_>
inline hxconstexpr auto hxconst_list<node_t_, deleter_t_>::begin(void) const -> const_iterator {
	return const_iterator(m_sentinel_.m_list_next_, &m_sentinel_);
}

template<typename node_t_, typename deleter_t_>
inline hxconstexpr auto hxconst_list<node_t_, deleter_t_>::end(void) const -> const_iterator {
	return const_iterator(const_cast<hxconst_list_node*>(&m_sentinel_), &m_sentinel_);
}

template<typename node_t_, typename deleter_t_>
template<typename deleter_override_t_>
inline hxconstexpr void hxconst_list<node_t_, deleter_t_>::clear(
...
template<typename node_t_, typename deleter_t_>
template<typename deleter_override_t_>
inline hxconstexpr void hxconst_list<node_t_, deleter_t_>::erase(
...
template<typename node_t_, typename deleter_t_>
inline hxconstexpr hxptr<node_t_, deleter_t_> hxconst_list<node_t_, deleter_t_>::extract(
		const_iterator pos_) {
	node_t_* ptr_ = static_cast<node_t_*>(pos_.m_current_node_);
	this->extract_(pos_.m_current_node_);
...
template<typename node_t_, typename deleter_t_>
inline hxconstexpr node_t_& hxconst_list<node_t_, deleter_t_>::front(void) {
	hxassert_hard(!this->empty(), "empty_list");
	return *static_cast<node_t_*>(m_sentinel_.m_list_next_);
}

template<typename node_t_, typename deleter_t_>
inline hxconstexpr const node_t_& hxconst_list<node_t_, deleter_t_>::front(void) const {
	hxassert_hard(!this->empty(), "empty_list");
...
inline hxconstexpr auto hxconst_list<node_t_, deleter_t_>::insert_after(
...
template<typename node_t_, typename deleter_t_>
template<typename ptr_deleter_t_>
inline hxconstexpr auto hxconst_list<node_t_, deleter_t_>::insert(
		const_iterator pos_, hxptr<node_t_, ptr_deleter_t_>&& ptr_) -> iterator {
...
template<typename node_t_, typename deleter_t_>
inline hxconstexpr hxptr<node_t_, deleter_t_> hxconst_list<node_t_, deleter_t_>::pop_back(void) {
	hxassert_hard(!this->empty(), "empty_list");
...
template<typename node_t_, typename deleter_t_>
inline hxconstexpr hxptr<node_t_, deleter_t_> hxconst_list<node_t_, deleter_t_>::pop_front(void) {
	hxassert_hard(!this->empty(), "empty_list");
...
template<typename node_t_, typename deleter_t_>
template<typename ptr_deleter_t_>
inline hxconstexpr auto hxconst_list<node_t_, deleter_t_>::push_back(
		hxptr<node_t_, ptr_deleter_t_>&& ptr_) -> iterator {
	return this->push_back(ptr_.release());
}

template<typename node_t_, typename deleter_t_>
inline hxconstexpr auto hxconst_list<node_t_, deleter_t_>::push_back(node_t_* ptr_) -> iterator {
...
template<typename node_t_, typename deleter_t_>
template<typename ptr_deleter_t_>
inline hxconstexpr auto hxconst_list<node_t_, deleter_t_>::push_front(
		hxptr<node_t_, ptr_deleter_t_>&& ptr_) -> iterator {
	return this->push_front(ptr_.release());
}

template<typename node_t_, typename deleter_t_>
inline hxconstexpr auto hxconst_list<node_t_, deleter_t_>::push_front(node_t_* ptr_) -> iterator {
	this->insert_(&m_sentinel_, m_sentinel_.m_list_next_, ptr_);
	return iterator(ptr_, &m_sentinel_);
}

template<typename node_t_, typename deleter_t_>
inline hxconstexpr void hxconst_list<node_t_, deleter_t_>::release_all(void) {
	m_sentinel_.m_list_prev_ = &m_sentinel_;
	m_sentinel_.m_list_next_ = &m_sentinel_;
	m_size_ = 0u;
}
...
inline hxconstexpr size_t hxconst_list<node_t_, deleter_t_>::remove_if(predicate_t_ predicate_) {
	size_t count_ = 0u;
	hxconst_list_node* n_ = m_sentinel_.m_list_next_;
	while(n_ != &m_sentinel_) {
		hxconst_list_node* next_ = n_->m_list_next_;
...
template<typename node_t_, typename deleter_t_>
inline hxconstexpr void hxconst_list<node_t_, deleter_t_>::reverse(void) {
...
template<typename node_t_, typename deleter_t_>
inline hxconstexpr void hxconst_list<node_t_, deleter_t_>::splice(
		const_iterator pos_, hxconst_list& other_) {
	hxassertmsg(&other_ != this && pos_.m_current_node_ != hxnull, "invalid_splice");
	if(other_.empty()) {
		return;
	}
	hxconst_list_node* pos_node_ = pos_.m_current_node_;
...
template<typename node_t_, typename deleter_t_>
inline hxconstexpr void hxconst_list<node_t_, deleter_t_>::insert_(
...
template<typename node_t_, typename deleter_t_>
inline hxconstexpr void hxconst_list<node_t_, deleter_t_>::extract_(hxconst_list_node* ptr_) {
	hxassert_hard(!this->empty(), "empty_list");
	hxassertmsg(ptr_ != hxnull, "invalid_node");
