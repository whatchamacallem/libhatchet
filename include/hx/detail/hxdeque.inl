...
template<typename T_, hxsize_t capacity_>
hxinline hxattr_flatten T_& hxdeque<T_, capacity_>::at(hxsize_t index_) {
	hxassert_hard(static_cast<size_t>(index_) < m_tail_ - m_head_, "invalid_index %zu", index_);
	const size_t mask_ = static_cast<size_t>(this->capacity()) - 1u;
	return this->data()[(m_head_ + static_cast<size_t>(index_)) & mask_];
}
...
template<typename T_, hxsize_t capacity_>
hxinline hxattr_flatten const T_& hxdeque<T_, capacity_>::at(hxsize_t index_) const {
	hxassert_hard(static_cast<size_t>(index_) < m_tail_ - m_head_, "invalid_index %zu", index_);
	const size_t mask_ = static_cast<size_t>(this->capacity()) - 1u;
	return this->data()[(m_head_ + static_cast<size_t>(index_)) & mask_];
}
...
template<typename T_, hxsize_t capacity_>
hxinline hxattr_flatten bool hxdeque<T_, capacity_>::empty(void) const { return m_tail_ == m_head_; }
