...
bool hxarray_test_is_max_heap(const array_t& heap) {
...
TEST_F(hxarray_test_f, modification) {
	const hxsystem_allocator_scope temporary_stack_scope(hxsystem_allocator_temporary_stack);
	{
		hxarray<hxtest_object> objs { 91, 92, 93, 94, 95 };
		...
		const hxarray<hxtest_object> objs2 { 99 };
		objs += objs2;
...
TEST(hxarray_test, for_each_invokes_callables) {
	const hxsystem_allocator_scope temporary_stack_scope(hxsystem_allocator_temporary_stack);
	hxarray<int> objs { 91, 92, 93, 94, 95 };
...
TEST(hxarray_test, generate_n_appends_callable_results) {
	const hxsystem_allocator_scope temporary_stack_scope(hxsystem_allocator_temporary_stack);
	hxarray<int> values;
	values.reserve(6u);
