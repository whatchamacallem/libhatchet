...
`<cstdio>`. Generously use `hxassertmsg` for debug asserts and `hxassertrelease`
...
for `ILP32`, `LP64` and `LLP64` are required to pass tests. All HX_RELEASE 
levels 0-3 are required to pass tests.
